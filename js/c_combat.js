...
function c_shootFireball(entity) {
	...
	wr_fireball.acc         =  0.7;                  //acceleration power (pixel/tick^2), costant
	...
	wr_fireball.forceRadius =  600;

	wr_fireball.explRadius  =  100;
...

{
	...
	if (pDist <= rocket.explRadius) {
	    ...
	    s_loadSoundHandler('P_EXPLSTUNNING', 0.04 * sSettings.sound_volume);
