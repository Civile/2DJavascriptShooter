...
function __player(x, y)
{
    ...
    */
    ...
    this.max_falling_acceleration = 12;
	...
	this.move = function(direction)
	{
		...
		switch ( direction )
		{
		    ...
		    case SPRINT:
			    ...
			    if (!this.sprint_charge_usable || this.xvel == 0)
			        break;
    ...
    */
	this.update = function()
	{
	    ...
	    if (this.yvel != 0 && !d) {
	        ...
	        this.isMovingOnY = false;
	        if (this.yvel >= 20 && keyShift) {
	            camera.shake(12, 2);
	            s_loadSoundHandler('P_HIGHVELCOLLISION', null);
	            c_radiusDamage(this, this, this, 15, 300, new Array('monster'));
	        }
	        this.yvel = 0;
