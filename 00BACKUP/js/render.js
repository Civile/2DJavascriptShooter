...
function Render() {
    ...
    this.render = function () {
        ...
        for (var i in this.buffer) {
            ...
            switch (this.buffer[i].type) {
                ...
                case 'terrain_rock1':
                case 'movable_floor':
                    this.renderRect_ext(this.buffer[i].xpos, this.buffer[i].ypos, this.buffer[i].width, this.buffer[i].height, this.ctx.createPattern(this.solidPattern, 'repeat'));
                    break;
                case 'teleporter':
    ...
    this.renderMonster = function (x, y, width, height, type, e) {
        ...
        switch (type) {
            ...
            case 'heavySoldier':
                ...
                this.ctx.arc(x + width / 2, y + e.height / 3 + 10, 30, Math.PI, false);
                this.ctx.fill();
                this.ctx.restore();
    ...
    */
    ...
    this.renderPlayer = function () {
        ...
        //Player speed trace
        if (player.xvel < -11 || player.xvel > 11) {
            pt = new Object();
